...
public class MemoryUploading implements Uploading {
  ...
  @Override
  public CompletionStage<Object> upload(String spaceName, BinaryPublisher contents) {
    return start()
      .thenCompose(__ -> allSpaces.belongingTo(spaceName))
      .thenCompose(space -> objects(space, contents));
  }

  private static CompletionStage<Object> objects(Space space, BinaryPublisher contents) {
